...
<div class="row">
	...
	<div class="col-sm-10">
	 ...
	 <div class="panel-heading"><h3>Daftar Jenis Kelamin</h3></div>
</div>
			    <a href="create.php" class="btn btn-success"><i class="glyphicon glyphicon-plus "></i> Tambah Jenis Kelamin</a>
			    <div>&nbsp;</div>
